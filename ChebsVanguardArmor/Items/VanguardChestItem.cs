...
namespace ChebsVanguardArmor.Items
{
    ...
    {
        public override string ItemName => "ChebGonaz_VanguardChest";
        public override string PrefabName => "ChebGonaz_VanguardChest.prefab";
        public override string NameLocalization => "$chebgonaz_vanguardchest";
        public override string DescriptionLocalization => "$chebgonaz_vanguardchest_desc";
