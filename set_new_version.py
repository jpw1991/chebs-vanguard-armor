...
if __name__ == '__main__':
    ...
    file_pattern_replacements = [
        FilePatternReplacement('ChebsVanguardArmor/Properties/AssemblyInfo.cs',
                               'AssemblyVersion\\([".0-9]+\\)',
                               f'AssemblyVersion("{version}.0")'),
        FilePatternReplacement('ChebsVanguardArmor/Properties/AssemblyInfo.cs',
                               'AssemblyFileVersion\\([".0-9]+\\)',
                               f'AssemblyFileVersion("{version}.0")'),
        FilePatternReplacement('ChebsVanguardArmor/ChebsVanguardArmor.cs',
                               'PluginVersion = [".0-9]+',
                               f'PluginVersion = "{version}"'),
        FilePatternReplacement('ChebsVanguardArmor/Package/manifest.json',
                               '"version_number": [".0-9]+',
